class UsersController < ApplicationController
  def index
    ...
    @users = @q.result(:distinct => true).includes(:photos, :likes, :sent_friend_requests, :received_friend_requests, :favorites, :following, :followers).page(params[:page]).per(10)
